...
// Date: 2025-04-23
//
// Description: This module provides support for checking if the CPU supports
// the RDRAND and RDSEED instructions, as well as generating random numbers
// using these instructions. It includes both the implementation of low-level
// assembly calls and fallback mechanisms for systems that don't have hardware
// support for these instructions.
//
// Key Features:
// - Checks for DRNG support (RDRAND/RDSEED) on Intel CPUs.
// - Generates random numbers using RDRAND for different sizes (16, 32, 64 bits).
