...
//
// Key Features:
// - Defines constants for the ASCON cipher variants, tag size, hash size,
//   and various rates for different operations.
// - Specifies the number of rounds for different ASCON modes.
// - Provides initialization vectors (IVs) for various cipher operations.
//
// Libraries Used:
