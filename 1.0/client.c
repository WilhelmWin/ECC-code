...
int main(int argc, char *argv[]) {
    ...
    // Compute the shared secret key using Diffie-Hellman key exchange keys
    crypto_scalarmult(ctx.shared_secret, ctx.private_key, server_public_key);  // Compute the shared secret
